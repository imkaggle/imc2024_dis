...
def calculate_missing_correspondences_scores_fn(save_path, old_db_path,
         use_E=False,
    ...
    num_valid_depths = np.zeros((num_images, num_images), dtype=np.int64)
...
def calculate_score_for_one_image(id0,
    ...
    if scales is None:
        ...
        num_valid_depths = np.zeros((num_images,), dtype=np.int64)
